...
const DATA_RESPONSES: V3CannedResponse[] = [
  ...
  {
    id: 'stmt_cashflow_last_quarter',
    question: 'Show the Cash Flow Statement for last quarter',
    pages: ['home', 'office:krishan'],
    keywords: ['cash flow statement', 'last quarter'],
    agentId: 'krishan',
    headline: 'Preparing cash flow statement for last quarter.',
    body: 'I can render the full indirect-method statement with operating, investing, and financing sections.',
  },
  {
    id: 'stmt_profit_last_month',
    question: 'What was our profit last month?',
    pages: ['home', 'office:krishan'],
    keywords: ['profit', 'last month'],
    agentId: 'krishan',
    headline: 'Pulling last month profit.',
    body: 'I can generate the full statement and show bottom-line movement with variance.',
  },
  {
    id: 'stmt_pnl_this_quarter',
    question: 'Show me the P&L for this quarter',
    pages: ['home', 'office:krishan'],
    keywords: ['p&l', 'this quarter'],
    agentId: 'krishan',
    headline: 'Pulling quarter P&L.',
    body: 'I can generate a Schedule III P&L with prior-period comparison and variance.',
  },
  {
    id: 'q4_meta_spend',
